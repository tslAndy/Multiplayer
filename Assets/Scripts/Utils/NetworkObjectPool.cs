...
namespace Utils
{
    ...
    public class NetworkObjectPool : NetworkBehaviour
    {
        ...
        private Dictionary<GameObject, int> nonPooledObject = new();
        ...
        public int GetCurrentPrefabCount(GameObject prefab) => nonPooledObject[prefab];
